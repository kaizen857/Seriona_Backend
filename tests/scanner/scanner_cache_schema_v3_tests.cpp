...
TEST_CASE("sqlite scanner cache schema v3 artifact validates against a temp database") {
  ...
  CHECK(sqlite3_exec(db, "INSERT INTO locations(location_id, content_id, root_path, file_path, file_size_bytes, file_mtime_ns, source_file_path, cue_track_offset_ms, artwork_path, lyrics_source, external_lrc_path, external_lrc_mtime_ns, discovered_at_ms, scanned_at_ms) VALUES('location-1', 'content-1', '/music', '/music/track.flac', 4096, 1000, '/music/track.flac', 5, '/music/cover.jpg', 'embedded', '/music/track.lrc', 2000, 10, 11);", nullptr, nullptr, nullptr) == SQLITE_OK);
  ...
  CHECK(sqlite3_exec(db, "INSERT INTO locations(location_id, content_id, root_path, file_path, file_size_bytes, file_mtime_ns, source_file_path, cue_track_offset_ms, artwork_path, lyrics_source, external_lrc_path, external_lrc_mtime_ns, discovered_at_ms, scanned_at_ms) VALUES('location-2', 'content-1', '/music', '/music/track.flac', 4096, 1000, '/music/track.flac', 5, '/music/cover.jpg', 'embedded', '/music/track.lrc', 2000, 10, 11);", nullptr, nullptr, nullptr) != SQLITE_OK);
  CHECK(sqlite3_exec(db, "INSERT INTO locations(location_id, content_id, root_path, file_path, file_size_bytes, file_mtime_ns, source_file_path, cue_track_offset_ms, artwork_path, lyrics_source, external_lrc_path, external_lrc_mtime_ns, discovered_at_ms, scanned_at_ms) VALUES('location-3', NULL, '/music', '/music/other.flac', 4096, 1000, '/music/other.flac', NULL, NULL, 'embedded', NULL, NULL, 10, 11);", nullptr, nullptr, nullptr) != SQLITE_OK);
