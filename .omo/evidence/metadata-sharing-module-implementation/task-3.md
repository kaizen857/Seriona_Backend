...
- Verification passed: `cmake --build build --target seriona_metadata_contract_tests` and `ctest --test-dir build -R seriona.metadata_contract --output-on-failure` both passed.
