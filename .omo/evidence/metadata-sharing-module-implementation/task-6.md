...
- Added failing-first service tests covering 500ms playback ticks, 1000ms timeline cadence, metadata-only changes, a real `TrackIdentity` change for immediate timeline updates, and stale snapshot rejection.
