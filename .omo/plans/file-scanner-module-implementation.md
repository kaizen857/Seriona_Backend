...
- [ ] 1. CMake foundation and dependency gates
...
- [ ] 2. Public scanner contracts and service facade
...
- [ ] 3. Scanner test harness, fakes, and temp fixtures
...
- [ ] 4. Path classification, sidecar LRC parsing, audio candidate filtering, and symlink policy
...
- [ ] 5. XXH3 file hash and directory Merkle hash
...
- [ ] 6. Playlist tree builder and snapshot publisher
...
- [ ] 7. Thread pool, bounded queues, cancellation, and progress throttling
...
- [ ] 8. SQLite cache layer with full metadata and migration
...
- [ ] 9. TagReader adapter and metadata mapping
...
- [ ] 11. wtr/watcher adapter, debounce, and runtime incremental updates
